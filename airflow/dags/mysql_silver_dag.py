...
with DAG(
    dag_id="mysql_silver_transformation",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    schedule=None,
    tags=["silver", "transformation", "transactions"],
) as dag:
    submit_silver_transformation_job = SparkSubmitOperator(
        task_id='submit_silver_transformation_job',
        application='/opt/spark/jobs/mysql_silver_transformation.py',
        conn_id='spark_default',
        name='mysql_silver_transformation',
        verbose=True,
